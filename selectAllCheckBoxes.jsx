...
const CheckboxList = () => {
	...
	const handleOption = (id) => {
		const updateAllCheckboxes = checkboxes.map((checkbox) =>
			checkbox.id === id ? { ...checkbox, checked: !checkbox.checked }
				: checkbox
		)
		setCheckboxes(updateAllCheckboxes)
	}
	...
	return (
		<Container>
			...
			<SelectAllButton data-testid="button" onClick={handleButtonClicked} >Select All</SelectAllButton>
		</Container>
	)
}
